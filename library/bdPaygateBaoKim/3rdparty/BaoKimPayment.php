...
class BaoKimPayment 
{
	...
	public $baokim_url = 'https://www.baokim.vn/payment/order/version11';

	// Mã merchante site 
	public $merchant_id = '100001';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	public $secure_pass = 'DED01D1CFF3BE2767196FF0080F6DB6D5C'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
